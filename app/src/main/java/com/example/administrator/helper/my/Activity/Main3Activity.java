        ...
        switch (v.getId()) {
            case R.id.Message_btn:
                ...
                if (userName.length() != 11) {
                    ...
                    Log.e("MESSAGE:", "3");
                    //进行获取验证码操作和倒计时1分钟操作
                    BmobSMS.requestSMSCode(this, userName, "项目测试", new RequestSMSCodeListener() {
                        @Override
                        public void done(Integer integer, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(Main3Activity.this, "验证码发送成功，请尽快使用", Toast.LENGTH_SHORT).show();
                                /**
                                 * 倒计时1分钟操作
                                 * 说明：
                                ...
                                Toast.makeText(Main3Activity.this, "验证码发送失败，请检查网络连接", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                ...
                if (userName.length() == 0 || passWord.length() == 0 || userName.length() != 11) {
                    ...
                    BmobSMS.verifySmsCode(this, userName, passWord, new VerifySMSCodeListener() {
                        ...
                        public void done(BmobException e) {
                            if (e == null) {
                                Log.e("MESSAGE:", "7");
                                Intent intent=new Intent(Main3Activity.this,HomePageFragment.class);
