 ...
 */
public class DaiKaiShiFragment extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener {
    ...
    public void getOrderData(){
        ...
        requestParams.addQueryStringParameter("orderStatusId",2+"");
