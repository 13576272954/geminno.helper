 ...
 */
public class DaiPingJiaFragment extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener {
    ...
    public void getOrderData(){
        ...
        requestParams.addQueryStringParameter("orderStatusId",4+"");
