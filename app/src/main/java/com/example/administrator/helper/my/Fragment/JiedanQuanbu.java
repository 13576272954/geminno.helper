 ...
 */
public class JiedanQuanbu extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener {
...
//    获取网络数据
    public void getOrderData(){
        ...
        //传参数：user_id,order_id
        Log.i("JiedanQuanbu", "getOrderData:  "+ getActivity());
    ...
    public void initItemView(ViewHolder viewHolder, Orders order, int position){
        ...
        //控件赋值
        if (order.getOrderStaus().getId()==3||order.getOrderStaus().getId()==4||order.getOrderStaus().getId()==5||
        order.getOrderStaus().getId()==6||order.getOrderStaus().getId()==7) {
    ...
    //按钮点击事件
    public void btnClick(final Orders order, final int position,Button btnLeft, Button btnRight){
        ...
        btnRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (order.getOrderStaus().getId()){
                    ...
                    case CANCEL:
                        //已完成 点击按钮删除此订单的显示
                        RequestParams requestParams2=new RequestParams(UrlUtils.MYURL+"JieDanDeleteServlet");
                        ...
                        break;
                    case CLOSE:
                        RequestParams requestParams3=new RequestParams(UrlUtils.MYURL+"JieDanDeleteServlet");
                        requestParams3.addBodyParameter("orderId",order.getId()+"");
                        //更新订单，更新界面
...
//            getOrderData();
//            Log.i("QuanBuFragment", "setUserVisibleHint: 12460.36");
//        }
//    }
//
//    @Override
