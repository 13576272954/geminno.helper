 ...
 */
public class JiedanWancheng extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener {
    ...
    public void getOrderData(){
        ...
        requestParams.addQueryStringParameter("orderStatusId",5+"");
