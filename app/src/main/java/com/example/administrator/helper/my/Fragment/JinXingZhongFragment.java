 ...
 */
public class JinXingZhongFragment extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener{
    ...
    public void getOrderData(){
        ...
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                Log.i("JinXingZhongFragment", "onSuccess:      "+result);
                List<Orders> newOrders=gson.fromJson(result,type);
                for (Orders order:newOrders
                     ) {
                    Log.i("JinXingZhongFragment", "onSuccess:wehkf     "+order);
    ...
    public void initItemView(ViewHolder viewHolder, Orders order, int position){
        ...
        Log.i("QuanBuFragment", "initItemView: "+"      "+order);
