...
public class RefreshListViews extends ListView implements AbsListView.OnScrollListener{
    ...
    public RefreshListViews(Context context) {
        this(context,null);
    }

    public RefreshListViews(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RefreshListViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initHead(Context context){
        ...
        headView= LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_head1,null);
        subHeadView=headView.findViewById(R.id.layout_ding);
        //初始化头部控件
       ...
       subHeadView.measure(0,0);
        headHeight=subHeadView.getMeasuredHeight();
       // int ding=subHeadView.getMeasuredHeight();
        //设置头部不显示
